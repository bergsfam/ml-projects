...
class Death(Scene):
    ...
    quips = [
        "You died.  You kind of stink at this.",
...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        if action == "shoot!":
            ...
            print "off your aim. Your laser his his costume but misses him entirely. This"
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        print "but you don't have time to look. There's 5 pods, which"
        print "one do you take?"

        good_pod = randint(1,5)
        guess = raw_input("[pod #]> ")

        if int(guess) == good_pod or int(guess) == 0:
